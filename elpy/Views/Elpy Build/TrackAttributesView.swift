            ...
            VStack {
                VStack {
                    ...
                    VStack(alignment: .leading) {
                        Text("To omit an attribute from your request,")
                        Text("leave the slider position all the way to the left.")
                        Text("Select ⓘ to learn how each index value is interpreted.")
                    }
                ...
                VStack{
                    HStack {
                        ...
                        .popover(isPresented: $showingPopulPopover) {
                            Text("How the Popularity index is calculated:")
                                .padding()
                ...
                VStack{
                    HStack {
                        ...
                        .popover(isPresented: $showingDancePopover) {
                            Text("How the Danceability index is calculcated:")
                                .padding()
                ...
                VStack{
                    HStack {
                        ...
                        .popover(isPresented: $showingInstrPopover) {
                            Text("How the Instrumentalness index is calculcated:")
                                .padding()
                ...
                VStack{
                    HStack {
                        ...
                        .popover(isPresented: $showingAcousPopover) {
                            Text("How the Acousticness index is calculcated:")
                                .padding()
                ...
                VStack{
                    HStack {
                        ...
                        .popover(isPresented: $showingValenPopover) {
                            Text("How the Valence index is calculcated:")
